...
const words = {
    en: {
        ...
        "PRICES": "PRICES",
        "ABOUT ME": "ABOUT ME",
        "(In Lynda Caisip CMT Salon)": "(In Lynda Caisip CMT Salon)",
        "Appointment Only": "Appointment Only",
        "Please text me": "Please text me",
        "Opening Hours": "Opening Hours",
        "Testimonials": "Testimonials",
        "One of the best massages I’ve ever had! Before the massage she asked me if anything hurt, or if she should focus on any areas.  I told her that my lower back and neck were a bit tight.  She was able to focus on the lower back and neck, and helped stretch my legs, arms, and lower back. She was able to apply good appropriate pressure.  I find that a lot of massage therapists aren’t able to apply enough pressure, but that was no issue for Rei, the pressure was perfect, and at the end of the massage I felt loose and relaxed.  Would definitely recommend and go again!": "One of the best massages I’ve ever had! Before the massage she asked me if anything hurt, or if she should focus on any areas.  I told her that my lower back and neck were a bit tight.  She was able to focus on the lower back and neck, and helped stretch my legs, arms, and lower back. She was able to apply good appropriate pressure.  I find that a lot of massage therapists aren’t able to apply enough pressure, but that was no issue for Rei, the pressure was perfect, and at the end of the massage I felt loose and relaxed.  Would definitely recommend and go again!",
        "-M": "-M",
        "I was very satisfied with her massage!  She took enough time to do counseling to  provide me with good care for pregnant before starting massage.  I'd like to recommend her to not only for pregnant but everyone!": "I was very satisfied with her massage!  She took enough time to do counseling to  provide me with good care for pregnant before starting massage.  I'd like to recommend her to not only for pregnant but everyone!",
        "-S": "-S",
        "If you want deep tissue, this is the massage for you!  It can be painful, but your body feels amazing afterwards!  Rei will customize the massage for you, so you don't have to go that hard, but I love it!!": "If you want deep tissue, this is the massage for you!  It can be painful, but your body feels amazing afterwards!  Rei will customize the massage for you, so you don't have to go that hard, but I love it!!",
        "-K": "-K",
        ...
        "We are located in Lynda Caisip CMT Salon.": "We are located in Lynda Caisip CMT Salon.",
    ...
    jp: {
        ...
        "PRICES": "料金表",
        "ABOUT ME": "自己紹介",
        "(In Lynda Caisip CMT Salon)": "(Lynda Caisip CMT表示のあるサロン内になります)",
        "Our Location": "住所",
        "Appointment Only": "ご予約の方のみ受け付けております",
        "Please text me": "テキストにてお問い合わせ下さい",
        "Opening Hours": "営業時間",
        "Testimonials": "お客様の感想",
        "One of the best massages I’ve ever had! Before the massage she asked me if anything hurt, or if she should focus on any areas.  I told her that my lower back and neck were a bit tight.  She was able to focus on the lower back and neck, and helped stretch my legs, arms, and lower back. She was able to apply good appropriate pressure.  I find that a lot of massage therapists aren’t able to apply enough pressure, but that was no issue for Rei, the pressure was perfect, and at the end of the massage I felt loose and relaxed.  Would definitely recommend and go again!": "アメリカに来てから、長年マッサージを受けには行っていなかったのですが、日本のようなマッサージを受けれると聞いて、嬉しくて、すぐに伺いました。結果、痛い所はないかなど、細かく聞いて下さり、久しぶりに日本のような指圧マッサージをうけることができました。身体も以前に比べたら、かなり軽くなりました。定期的に通いたいと思います。本当にありがとうございました。また、どうぞ宜しくお願い致します。",
        "-M": "M.T.",
        "I was very satisfied with her massage!  She took enough time to do counseling to  provide me with good care for pregnant before starting massage.  I'd like to recommend her to not only for pregnant but everyone!": "イベント明けに全身の疲れを取ろうとマッサージお願いしてみて、すごくよかったので、子育やら仕事やら、家事などでお疲れのママや、もちろんパパにもおすすめです！３回セットでお願いして試してみました、マッサージ後の体の軽さはもちろん、その後の体の疲労がいつもより軽い！そして、体の自分での改善のストレッチなども教えて頂けるので、体が悲鳴を上げてる方！必見です！偏頭痛などおこらず、薬も飲まず、行けてます！奇跡です！本当にマッサージのおかげです。ぜひ、１回でも、２-３回でも続けてみるとより効果てきめんでした",
        "-S": "A.M.",
        "If you want deep tissue, this is the massage for you!  It can be painful, but your body feels amazing afterwards!  Rei will customize the massage for you, so you don't have to go that hard, but I love it!!": "ベイエリアのマッサージ店は数え切れないほどあるため、よい店を見つけることは困難です。経験上かなり怪しい店が多く。英語が通じなかったり、マッサージも優しすぎて物足りない事がほとんどでした。それに対して日本人で、専門的なトレーニングを受けた本格的なマッサージです。規定の時間、丁寧にマッサージをしてくれます。具合の悪いところについて日本語で細かく説明できる点も日本人には魅力です。マッサージのトレーニングはアメリカで受けたそうで、日本で学んだわけではないそうです。主に指圧のような押すマッサージと、タイ式のような伸ばすマッサージでした。",
        "-K": "K.Y.",
        "Prologue": "はじめに",
        ...
        "Newbury Park": "Newbury Park",
        "Text: (510) 684-0386": "Text: (510) 684-0386",
        "We are located in Lynda Caisip CMT Salon.": "Lynda Caisip CMT表示のあるサロン内になります",
